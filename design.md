...
5. **Dense fields are the working-surface default.** Full 56dp fields remain in dialogs only; board sorting and creation controls, the card detail drawer, and the quick-action composer use 44dp dense fields so data-heavy surfaces stay compact and the 320px board remains operable.
