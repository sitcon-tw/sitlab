...
export type CreateCardCommentResult = components["schemas"]["CreateCardCommentResult"];
export type QuickActionCommand = components["schemas"]["QuickActionCommand"];
export type QuickActionSuggestion = components["schemas"]["QuickActionSuggestion"];
export type QuickActionSuggestionKind = components["schemas"]["QuickActionSuggestion"]["kind"];
