...
const rawColorAllowlist = new Map([
	...
	["web/src/features/board/labelsApi.ts", "GitLab label demo payloads require concrete API color metadata"],
	["web/src/features/board/labelPalette.ts", "the label color picker mirrors GitLab's own suggested label colors"],
